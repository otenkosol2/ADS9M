...
\begin{frame}
\frametitle{Relation to \emph{full abstraction}} %Mention secure compilation?
...
\underline{Intuition}: attacking the compiled code is as hard as attacking the source code %Even though the target language is usually lower level and hence more powerful as an attacker
\end{block}
\only<2>{
